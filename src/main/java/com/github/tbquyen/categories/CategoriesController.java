...
public class CategoriesController {
  ...
  public static final String VIEW_HOME = "categories/categories";
  public static final String VIEW_EDIT = "categories/categoriesForm :: CategoriesForm";
  @Autowired
  ...
  @ResponseBody
  public String categoriesPOST(@ModelAttribute("DataTablesUsersRequest") CategoriesDataTablesRequest form) {
  ...
  @GetMapping(value = "/{id}")
  public ModelAndView categoriesGETID(@ModelAttribute("CategoriesForm") Categories form,
      @PathVariable(name = "id") long id) {
    LOGGER.debug("categoriesGETID: " + id);

    Categories user = service.getEntityById(id);
  ...
  public ModelAndView categoriesPOSTID(@ModelAttribute("CategoriesForm") @Validated Categories form,
